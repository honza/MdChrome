// MdChrome by Honza Pokorny - (c) 2011
// http://github.com/honza
...
(function() {
  ...
  var styleUrl = chrome.extension.getURL("style.css");
  injectStyle(styleUrl);

  content = content[0];
  var html = markdown.toHTML(content.innerHTML.replace(/&gt;/g, ">"));

  content.innerHTML = "";
  var res = document.createElement('div');
  res.setAttribute('class', 'mdchrome-render-class');
  res.innerHTML = html;
